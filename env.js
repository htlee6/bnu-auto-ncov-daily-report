...
const MAIL_TEMPLATE_PATH = path.resolve(__dirname, './mail-template.json')
const WECHAT_TEMPLATE_PATH = path.resolve(__dirname, './wechat-template.json')
...
exports.MAIL_TEMPLATE_PATH = MAIL_TEMPLATE_PATH
exports.WECHAT_TEMPLATE_PATH = WECHAT_TEMPLATE_PATH
